...
#include "../src/request_handling.h"
...
size_t SelectRandomTime(size_t max) {
    return std::rand() % max;
}
...
//
//         WHEN("Adding 100 players and moving them 100 times for less than 15 sec") {
//             std::unordered_map<const app::Token*, size_t> token_map;
//
//             for(int i = 0; i < 1000; ++i) {
//                 auto result = game_app->JoinGame("town", "tribe" + std::to_string(i));
...
//                 game_app->AdvanceGameTime(model::TimeMs{SelectRandomTime(15000)});
//             }
//         }
//     }
// }
